...
function ordenarCanchas(canchas) {
    return canchas.sort((a, b) => {
        ...
        // 2. Por deporte con ordenamiento NATURAL
        ...
        // 3. Por nombre de cancha con ordenamiento natural
...
async function inicializarFiltros() {
    ...
    try {
        ...
        mostrarMensaje('Error al cargar establecimientos, canchas o usuarios');
    }
...
async function aplicarFiltros() {
    ...
    deseleccionarTodo();
    canchasMostradas = CANTIDAD_INICIAL;
...
function inicializarBusquedaUsuario() {
    ...
    // Cerrar sugerencias al perder foco (con delay para permitir click)
